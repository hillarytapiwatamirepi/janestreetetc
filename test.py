...
def main():
    ...
    bids[id] = {"type": "add", "order_id": id, "symbol": "BOND", "dir": "BUY", "price":999, "size": 20}
    offers[id] = {"type": "add", "order_id": id, "symbol": "BOND", "dir": "SELL", "price":1001, "size": 20}
    write_to_exchange(exchange, json.dumps({"type": "add", "order_id": id, "symbol": "BOND", "dir": "BUY", "price":999, "size": 20}))
    write_to_exchange(exchange,json.dumps({"type": "add", "order_id": id, "symbol": "BOND", "dir": "SELL", "price":1001, "size": 20}))
